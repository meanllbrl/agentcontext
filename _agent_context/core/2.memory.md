...
Key decisions: React+Vite (full ecosystem), native drag-and-drop, no router library (5-page state switcher), custom CSS with design tokens, `dashboard/` isolated package. Agent character: brand diamond logo tied to sleep level (custom design deferred).
